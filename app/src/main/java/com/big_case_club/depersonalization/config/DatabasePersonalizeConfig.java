...
@EnableJpaRepositories(
        entityManagerFactoryRef = DatabasePersonalizeConfig.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = DatabasePersonalizeConfig.TRANSACTION_MANAGER,
        basePackages = DatabasePersonalizeConfig.JPA_REPOSITORY_PACKAGE
)
...
public class DatabasePersonalizeConfig {
    ...
    public static final String TRANSACTION_MANAGER = "personalizeTransactionManager";
