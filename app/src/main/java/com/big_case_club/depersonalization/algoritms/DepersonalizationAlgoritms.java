...
public class DepersonalizationAlgoritms {
    ...
    private final String[] firstNamesDictionary;
    private final String[] secondNameDictionary;
    ...
    public DepersonalizationAlgoritms() {
        ...
        secondNameDictionary = new String[] {"Князев","Смирнов","Юдин","Попов","Васильев","Демин","Кузин","Родионов","Фёдоров","Морозов","Долгов","Алексеев","Лебедев","Семёнов","Егоров","Федотов","Злобин","Сомов","Москвин","Гущин"};
        firstNamesDictionary = new String[] {"Александр","Иван","Лев","Игорь","Вася","Михаил","Дмитрий","Полина","Матвей","Света","Генадий","Даниил","Мария","Игнат","Евгений","Анна","Ева","Виктория","Александра","Анастасия"};
    }
